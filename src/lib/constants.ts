...
of it occuring for a company based in the sector that the user provides in their prompt. The likelihood should be
 a number from 1 to 5, use this to work out the decimal (4/5 would be 0.8). Output in plain JSON format ONLY as an array of objects
 with the following structure: { title: string, likelihood: number }, where title is the question and likelihood is its
 corresponding likelihood. Make sure the length of the array matches the amount of questions provided, no more, no less.
